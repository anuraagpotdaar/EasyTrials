...
public class MedicalHistoryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference partiCount = FirebaseDatabase.getInstance().getReference("Participants/"+ MedicalHistoryFragmentArgs.fromBundle(getArguments()).getSelectedParti());
        ...
        binding.btnHistoryBack.setOnClickListener(view1 -> {
            Navigation.findNavController(view).navigate(R.id.action_back_to_participantDetailsFragment);
        });
